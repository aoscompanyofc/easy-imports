...
export const DEVICE_CATALOG: DeviceBrand[] = [
  ...
  // ─── Apple iPad ────────────────────────────────────────────────────────────
  {
    ...
    models: [
      // ── iPad Pro ──────────────────────────────────────────────────────────────
      { name: 'iPad Pro 11" M5',  capacities: ['256GB', '512GB', '1TB', '2TB'],               colors: ['Preto Espacial', 'Prata'] },
  ...
  // ─── Apple MacBook ─────────────────────────────────────────────────────────
  {
    ...
    models: [
      // ── MacBook Pro M5 (2025) ────────────────────────────────────────────────
      { name: 'MacBook Pro 16" M5 Max', capacities: ['512GB', '1TB', '2TB', '4TB'], colors: ['Preto Espacial', 'Prata'] },
      { name: 'MacBook Pro 16" M5 Pro', capacities: ['512GB', '1TB', '2TB'],        colors: ['Preto Espacial', 'Prata'] },
      { name: 'MacBook Pro 14" M5 Max', capacities: ['512GB', '1TB', '2TB', '4TB'], colors: ['Preto Espacial', 'Prata'] },
      { name: 'MacBook Pro 14" M5 Pro', capacities: ['512GB', '1TB', '2TB'],        colors: ['Preto Espacial', 'Prata'] },
      { name: 'MacBook Pro 14" M5',     capacities: ['256GB', '512GB', '1TB'],      colors: ['Preto Espacial', 'Prata'] },
      // ── MacBook Pro M4 (2024) ────────────────────────────────────────────────
      ...
      { name: 'MacBook Pro 16" M2 Max', capacities: ['512GB', '1TB', '2TB', '4TB'], colors: ['Cinza Espacial', 'Prata'] },
      { name: 'MacBook Pro 16" M2 Pro', capacities: ['512GB', '1TB', '2TB'],        colors: ['Cinza Espacial', 'Prata'] },
      { name: 'MacBook Pro 14" M2 Max', capacities: ['512GB', '1TB', '2TB', '4TB'], colors: ['Cinza Espacial', 'Prata'] },
      { name: 'MacBook Pro 14" M2 Pro', capacities: ['512GB', '1TB', '2TB'],        colors: ['Cinza Espacial', 'Prata'] },
      { name: 'MacBook Pro 13" M2',     capacities: ['256GB', '512GB', '1TB', '2TB'], colors: ['Cinza Espacial', 'Prata'] },
      // ── MacBook Pro M1 (2020–2021) ───────────────────────────────────────────
      { name: 'MacBook Pro 16" M1 Max', capacities: ['512GB', '1TB', '2TB'],        colors: ['Cinza Espacial', 'Prata'] },
      { name: 'MacBook Pro 16" M1 Pro', capacities: ['512GB', '1TB', '2TB'],        colors: ['Cinza Espacial', 'Prata'] },
      ...
      { name: 'Mac mini M2 Pro', capacities: ['512GB', '1TB', '2TB'] },
      { name: 'Mac mini M2',     capacities: ['256GB', '512GB', '1TB', '2TB'] },
      { name: 'Mac mini M1',     capacities: ['256GB', '512GB', '1TB', '2TB'] },
      { name: 'Mac mini (Intel 2020)', capacities: ['256GB', '512GB', '1TB', '2TB'] },
      // ── Mac Studio ───────────────────────────────────────────────────────────
      { name: 'Mac Studio M4 Max',   capacities: ['512GB', '1TB', '2TB', '4TB', '8TB'] },
      { name: 'Mac Studio M2 Max',   capacities: ['512GB', '1TB', '2TB', '4TB'] },
      { name: 'Mac Studio M2 Ultra', capacities: ['1TB', '2TB', '4TB', '8TB'] },
      { name: 'Mac Studio M1 Max',   capacities: ['512GB', '1TB', '2TB'] },
  ...
  // ─── Apple Watch ───────────────────────────────────────────────────────────
  {
    ...
    models: [
      { name: 'Apple Watch Series 11', capacities: ['42mm', '46mm'], colors: ['Preto', 'Prata', 'Ouro Rosa', 'Titânio Natural'] },
      { name: 'Apple Watch Ultra 3',   capacities: ['49mm'],         colors: ['Titânio Natural', 'Titânio Preto'] },
      { name: 'Apple Watch Series 10', capacities: ['42mm', '46mm'], colors: ['Preto', 'Prata', 'Ouro Rosa', 'Polido Natural', 'Ouro', 'Ardósia'] },
      { name: 'Apple Watch Ultra 2',   capacities: ['49mm'],         colors: ['Titânio Natural', 'Titânio Preto'] },
      { name: 'Apple Watch Series 9',  capacities: ['41mm', '45mm'], colors: ['Meia-Noite', 'Estelar', 'Vermelho', 'Prata', 'Rosa'] },
      { name: 'Apple Watch Ultra',     capacities: ['49mm'],         colors: ['Titânio Natural'] },
      { name: 'Apple Watch Series 8',  capacities: ['41mm', '45mm'], colors: ['Meia-Noite', 'Estelar', 'Vermelho', 'Prata'] },
      { name: 'Apple Watch SE 2',      capacities: ['40mm', '44mm'], colors: ['Meia-Noite', 'Estelar', 'Prata'] },
