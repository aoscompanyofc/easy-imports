      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            type={type}
            className={cn(
              'w-full rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-2.5 text-sm text-neutral-900 outline-none focus:ring-2 focus:ring-primary/25 focus:border-primary transition-all duration-200',
